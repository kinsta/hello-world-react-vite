  ...
  return (
    <div className="App">
      <div className="circles">
        <div className="circle c1 bg-kinsta-blur-1"></div>
        <div className="circle c2 bg-kinsta-blur-2"></div>
        <div className="circle c3 bg-kinsta-blur-3"></div>
    </div>
    <div className="pt-[10vh] px-2 mx-auto max-w-[880px] lg:min-h-screen">
        <a href="https://kinsta.com" className="block text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="inline h-[120px] w-auto" width="320" height="240" viewBox="0 0 800 600">
        ...
        <article className="mt-4 rounded rounded-[40px] p-[2px] bg-gradient-to-b from-kinsta-shadow to-kinsta-shadow/0">
            ...
            <div className="grid gap-[5px] lg:grid-cols-2 grid-cols-1 mt-10">
                <a href="https://react.dev/" target="_blank" rel="noreferrer" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" >
                    <h3 className="text-white font-bold mb-4 text-[20px]">Official React Website</h3>
                    <p className="text-white/50 text-[16px]">Learn more about React’s capabilities through its official site.</p>
                    
                    <svg className="absolute top-1/2 mt-[-7px] right-[24px] transition-all delay-150 opacity-0" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.7363 0.633721C11.0877 0.282249 11.6576 0.282249 12.0091 0.633721L17.7366 6.36126C17.9043 6.52894 17.992 6.74633 17.9996 6.966C18.0006 6.99333 18.0003 7.02069 17.9988 7.048C17.9984 7.05428 17.998 7.06056 17.9976 7.06683C17.98 7.30666 17.8684 7.52038 17.6996 7.67132L12.0091 13.3618C11.6576 13.7133 11.0877 13.7133 10.7363 13.3618C10.3848 13.0104 10.3848 12.4405 10.7363 12.089L14.9252 7.9001H0.9C0.402944 7.9001 0 7.49715 0 7.0001C0 6.50304 0.402944 6.1001 0.9 6.1001H14.9298L10.7363 1.90651C10.3848 1.55504 10.3848 0.985193 10.7363 0.633721Z" fill="white"/>
                    </svg>
                </a>

                <a href="https://react.dev/learn" target="_blank" rel="noreferrer" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" >
                    <h3 className="text-white font-bold mb-4 text-[20px]">React Documentation</h3>
                    <p className="text-white/50 text-[16px]">Visit React’s documentation to learn how to edit this page.</p>
                ...
                <a href="https://github.com/kinsta" rel="noreferrer" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" >
                    <h3 className="text-white font-bold mb-4 text-[20px]">Kinsta GitHub</h3>
                    <p className="text-white/50 text-[16px]">Find more inspiration and starters on Kinsta’s GitHub.</p>
                ...
                <a href="https://kinsta.com/discord" rel="noreferrer" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" >
                    <h3 className="text-white font-bold mb-4 text-[20px]">Kinsta Discord</h3>
                    <p className="text-white/50 text-[16px]">Join Kinsta's Discord and connect with other developers.</p>
                ...
                <a href="https://twitter.com/kinsta" rel="noreferrer" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" >
                    <h3 className="text-white font-bold mb-4 text-[20px]">Kinsta Twitter</h3>
                    <p className="text-white/50 text-[16px]">Follow Kinsta’s Twitter for the latest updates, resources, and gifs.</p>
        ...
        <p>Host your new site on Kinsta. <a href="https://kinsta.com/application-hosting/" className="text-[#A99FFB] hover:text-white transition-all delay-100" >Start your free trial</a>.</p></div>
    </div>
    </div>
  );
}
